...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'clave_fallback_segura')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('DJANGO_DEBUG', 'False').lower() in ('true', '1', 't')

ALLOWED_HOSTS = ['portfolio-diego-brito-sanchez.onrender.com']
...
# For development, use SQLite. For production, use PostgreSQL or another database.
# DATABASES = {
#     'default': {
...
CORS_ALLOWED_ORIGIN_REGEXES = [
    r"^https:\/\/portfolio-diego-brito-sanchez.*\.onrender\.com$",
]
